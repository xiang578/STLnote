...
// n 由用户定义，或者小于512时返回512/sz，或者返回1
...
struct __deque_iterator {
  ...
  T* first;//缓冲区的起点
  T* last;//缓冲区的终点
  map_pointer node;//当前缓冲区在map中的位置
...
#ifndef __STL_MEMBER_TEMPLATES  create_map_and_nodes
